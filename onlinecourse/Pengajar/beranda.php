...
$_SESSION['msg']="Kata Sandi Berhasil Diganti !!";
}
else
{
$_SESSION['msg']="Kata Sandi Tidak Sesuai !!";
}
}
?>
...
{
alert("Kata Sandi Saat Ini Kosong !!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.newpass.value=="")
{
alert("Kata Sandi Baru Kosong !!");
document.chngpwd.newpass.focus();
return false;
}
else if(document.chngpwd.cnfpass.value=="")
{
alert("Konfirmasi Kata Sandi Kosong !!");
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Ganti Kata Sandi Admin </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword3" name="cnfpass" placeholder="Konfirmasi Kata Sandi" />
  </div>
