...
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from students where StudentRegno = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Data Peserta Berhasil Dihapus !!";
      }
...
<head>
    ...
    <title>Admin | Data Peserta Kursus</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Data Peserta Kursus  </h1>
                    </div>
                </div>
                <div class="row" >
...
<a href="manage-students.php?id=<?php echo $row['StudentRegno']?>&del=delete" onClick="return confirm('Apakah anda yakin ingin menghapus?')">
                                            <button class="btn btn-danger">Hapus</button>
</a>
<a href="manage-students.php?id=<?php echo $row['StudentRegno']?>&pass=update" onClick="return confirm('Apakah anda yakin ingin mengatur ulang kata sandi?')">
