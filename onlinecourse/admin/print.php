...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               <b> No. Registrasi: </b><?php echo htmlentities($row['sregno']);?><br>
                               <b> Nama Peserta: </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b> Tanggal Registrasi:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Tanggal Registrasi Kursus:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
