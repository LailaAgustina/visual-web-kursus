...
if($ret)
{
$_SESSION['msg']="Data Peserta Berhasil diperbaharui !!";
}
else
{
  $_SESSION['msg']="Data Peserta tidak dapat diperbaharui";
}
}
?>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Profil Peserta </h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="CGPA">Nilai Rata-rata  </label>
