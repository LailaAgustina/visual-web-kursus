...
<head>
    <meta charset="utf-8">
    <title>Cetak Bukti Pendaftaraan</title>
...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               <b> No. Registrasi: </b><?php echo htmlentities($_SESSION['login']);?><br>
                               <b> Nama Peserta: </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b> Tanggal Registrasi Peserta Kursus:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Tanggal Registrasi Pengambilan Kursus:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
